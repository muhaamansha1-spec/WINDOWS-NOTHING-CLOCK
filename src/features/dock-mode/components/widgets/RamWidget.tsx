      ...
      <div className="relative w-24 h-24">
        <svg width="96" height="96" viewBox="0 0 96 96">
          ...
          <motion.circle
            ...
            cy="48"
            r="40"
            stroke={getColor(usagePercent)}
            strokeWidth="8"
            fill="none"
            strokeDasharray={251.2}
            strokeDashoffset={251.2 * (1 - usagePercent / 100)}
            strokeLinecap="round"
            style={{ filter: `drop-shadow(0 0 8px ${getColor(usagePercent)})` }}
            initial={{ strokeDashoffset: 251.2 }}
            animate={{ strokeDashoffset: 251.2 * (1 - usagePercent / 100) }}
...
RamWidget.displayName = 'RamWidget';